pro month_plan_Aug2019_10072019
  ...
  date=[2019, 08, 1, 15, 0]
  shift=0.0d
  shift=observation(date=date, texp=1560, ra=170.04282d, dec=-60.75630d, obsid='11910001001', shift=shift, table=table, target='Cen X-3 first light')
