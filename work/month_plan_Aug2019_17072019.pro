pro month_plan_Aug2019_17072019

  npol='RG_MonthPlan_2019-08_v03.txt'
  read_month_plan_npol,npol, seance_cut=60.
  
  fout=make_output_filename(prefix='P',postfix='RK',version='03')
  ...
  date=[2019, 08, 2, 15, 0]
  shift=0.0d
  shift=observation(date=date, texp=1530, ra=170.04282d, dec=-60.75630d, obsid='11910001001', shift=shift, table=table, target='Cen X-3 first light')
  ...
  write_plan,filename=fout, table=table, title='August 2019', npol=npol, info=info
end
