...
pro month_plan_Sep2019_21092019
  ...
  fout=make_output_filename(prefix='P',postfix='VA',version='16')
  
  info={INFO, AUTHOR:'Vadim Arefiev', EMAIL:'arefiev@cosmos.ru', replaces:'P_PLAN_190921_620611200_623289600_VA_v15.fits'}
...
;; ra, dec if specified take priority. If not, code calculates
...
;;  date=[2019, 09, 24, 16, 00]
;;  shift=0.0d
;;  shift=observation(date=date, texp=120, obsid='11910030001', $
...
;;                    cat_ra_obj=267.4854d, cat_dec_obj=-34.1459d, object='SRGA J174956-34086')
  ...
  shift=0.0d
  shift=observation(date=date, texp=90, obsid='11910014006', $
                    shift=shift, table=table, target='Sgr A*',relax_time=0, start_with_slew=0, $
                    cat_ra_obj=cat_ra_sgra, cat_dec_obj=cat_dec_sgra, object='Sgr A*')

  date=[2019, 09, 24, 18, 40]
  shift=0.0d
  shift=observation(date=date, texp=350, obsid='11910031001', $
                    shift=shift, table=table, target='3C390.3 seance',relax_time=0, start_with_slew=0, $
                    cat_ra_obj=280.537463d, cat_dec_obj=79.771425d, object='3C390d3', sun_x0z_angle=-12.5d)

 
;;  date=[2019, 09, 25, 18, 40]
;;  shift=0.0d
;;  shift=observation(date=date, texp=170+170+10, obsid='11910032001', $
;;                    shift=shift, table=table, target='1RXS J170849-400910 w/ 2h NPOL tests',relax_time=0, start_with_slew=0, $
;;                    cat_ra_obj=257.2042d, cat_dec_obj=-40.1528d, object='1RXS J170849-400910', sun_x0z_angle=0.0d)


  date=[2019, 09, 25, 18, 40]
  shift=0.0d
  shift=observation(date=date, texp=170+170+10, obsid='11910032001', $
                    shift=shift, table=table, target='IGR J16318-4848 w/ 2h NPOL tests',relax_time=0, start_with_slew=0, $
                    cat_ra_obj=247.951293d, cat_dec_obj=-48.816851d, object='IGR_J16318m4848', sun_x0z_angle=0.0d)



  date=[2019, 09, 26, 18, 50]
  shift=0.0d
  shift=observation(date=date, texp=170+170, obsid='11910033001', $
                    shift=shift, table=table, target='4U 1624-49 seance',relax_time=0, start_with_slew=0, $
                    cat_ra_obj=247.023049d, cat_dec_obj=-49.211114d, object='4U1624m49', sun_x0z_angle=0.0d)

  date=[2019, 09, 27, 18, 40]
  shift=0.0d
  shift=observation(date=date, texp=170+170+10, obsid='11910034001', $
                    shift=shift, table=table, target='SNR J1713A seance',relax_time=0, start_with_slew=0, $
                    cat_ra_obj=257.94d, cat_dec_obj=-39.543056d, object='SNR_J1713d7m3946', sun_x0z_angle=0.0d)


  date=[2019, 09, 28, 0, 40]
  shift=0.0d
  shift=observation(date=date, texp=200, obsid='11910014007', $
                    shift=shift, table=table, target='Sgr A*', relax_time=0, start_with_slew=0, $
                    cat_ra_obj=cat_ra_sgra, cat_dec_obj=cat_dec_sgra, object='Sgr A*')
