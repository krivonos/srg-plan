pro month_plan_Jul2019_16072019

  read_month_plan_npol,'RG_MonthPlan_2019-07_v07.txt'
  return
  fout=make_output_filename(prefix='P',postfix='VA',version='04')
  ...
  for i=0L, n_elements(grid)-1 do begin
     obsid=String(stem,i,format='(a,i02)')
  ...
  ;; 
  shift=observation(date=date, texp=950, ra=218.0d, dec=34.1d, obsid='019010108', shift=shift, table=table, target='XBootes field end')
  ...
  date=[2019, 08, 2, 15, 0]
  shift=0.0d
  shift=observation(date=date, texp=1560, ra=170.04282d, dec=-60.75630d, obsid='119110100', shift=shift, table=table, target='Cen X-3 first light')
  ...
  stem='1191101';; root for obsid +000
  date=[2019, 08, 3, 21, 0]
  shift=0.0d
  texp=130L
